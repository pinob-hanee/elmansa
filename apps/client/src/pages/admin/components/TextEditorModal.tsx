    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
      <div className="w-full max-w-4xl bg-surface-900 border border-surface-800 rounded-2xl shadow-2xl flex flex-col h-[85vh]">
        <div className="flex items-center justify-between px-6 py-4 border-b border-surface-800">
          <h2 className="text-xl font-bold text-white">تعديل محتوى المقال</h2>
        ...
        <div className="px-6 py-4 border-t border-surface-800 flex justify-end gap-3 bg-surface-900/50">
          <button 
            onClick={onClose}
            className="px-4 py-2 font-medium text-surface-300 hover:text-white bg-surface-800 hover:bg-surface-700 rounded-xl transition-colors"
          >
            إلغاء
          </button>
          <button 
